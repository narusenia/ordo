...
| M4 | Testing & Quality | TASK-020 ~ 024 | 5/5 | `ordo test/fmt/lint/check`, compile_commands.json |
...
| [#25](https://github.com/NaruseNia/ordo/issues/25) | System-level providers (brew, nix, pacman) | Done | L |
| [#26](https://github.com/NaruseNia/ordo/issues/26) | Project-level providers (clib, nuget) | Done | L |
| [#27](https://github.com/NaruseNia/ordo/issues/27) | Cargo provider (Rust crate C bindings) | Todo | XL |
| [#28](https://github.com/NaruseNia/ordo/issues/28) | Platform-conditional dependencies | Done | L |
...
| TASK-022 | Lint Command and compile_commands.json | Done | M |
| TASK-023 | Check Command | Done | S |
| TASK-024 | Scripts Command | Done | S |
...
| TASK-022 | Done | REQ-QUAL-002, REQ-QUAL-004 |
| TASK-023 | Done | REQ-BUILD-010 |
| TASK-024 | Done | REQ-PROJ-005 |
