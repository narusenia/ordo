...
|-----------|-------|-------|----------|-----------------|
| M1 | Foundation + MVP | TASK-001 ~ 007 | 4/7 | `ordo new`, `ordo build`, `ordo run` work for a single executable project |
...
| Task | Title | Status | Size |
|------|-------|--------|------|
| TASK-008 | Dependency Declaration and Resolver | Todo | L |
