...
use ordo_backend::provider::clib::ClibProvider;
use ordo_backend::provider::conan::ConanProvider;
use ordo_backend::provider::git::expand_git_shorthand;
use ordo_backend::provider::nix::NixProvider;
use ordo_backend::provider::nuget::NugetProvider;
use ordo_backend::provider::pacman::PacmanProvider;
use ordo_backend::provider::pkgconfig::PkgConfigProvider;
use ordo_backend::provider::system::SystemProvider;
use ordo_backend::provider::vcpkg::VcpkgProvider;
use ordo_backend::provider::{Provider, ResolvedDep};
...
fn verify_resolve(
    ...
    let result = match provider {
        "vcpkg" => {
            ...
            use ordo_backend::provider::vcpkg::VcpkgPackageSpec;
...
"#,
    ...
    fn add_pkg_config_dep() {
        ...
        let ctx = crate::context::Context::default_for_test();
        run_inner(
            tmp.path(),
            "pkg-config",
            "zlib",
